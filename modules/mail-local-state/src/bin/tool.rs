...
fn main() -> anyhow::Result<()> {
    ...
    let secret_key = match args.key {
        ...
        None => {
            ...
            const ID_FILE_NAME: &str = "mail-local-state-key";
            ...
            println!("storing public key file: `{ID_FILE_NAME}.public.pem`");
            std::fs::write(
    ...
    let params: Parameters = LocalStateParams { secret_key }.try_into()?;
    const PARAMS_FILE_NAME: &str = "mail-local-state-params";
