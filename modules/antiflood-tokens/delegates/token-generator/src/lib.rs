// When the `freenet-main-delegate` feature is off (the default in workspace
// builds), the #[delegate] macro expands to nothing and all helpers look
// unused. Same rationale as in contracts/inbox and identity-management.
